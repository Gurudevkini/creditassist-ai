    ...
    useEffect(() => {
        ...
        function idle() {
            ...
            if (
                ...
                const avaliableIdleAnimations = ["sleeping", "tired"]
                if (nekoPosX < 32) avaliableIdleAnimations.push("scratchWallW")
                if (nekoPosY < 32) avaliableIdleAnimations.push("scratchWallN")
